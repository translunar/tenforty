"""IRS-published 2024 Form 8962 (Premium Tax Credit) parameters.

Source: 2024 Instructions for Form 8962
(https://www.irs.gov/pub/irs-prior/i8962--2024.pdf).

Values were produced by two mutually-blind transcriber subagents, each
reading ONLY the 2024 Form 8962 instructions above (no tenforty code, no
...
tests/params_attestations/f8962_y2024.py (wired into
tests/test_params_attestation.py::F8962AttestationTests).

2024 continues the IRA-extended applicable-figure table shape (0.00 floor
...
year. The unemployment-compensation special rule does NOT apply in 2024
(it was a 2021-only ARPA provision). fpl_single_48 is the 2023-published
...
PARAMS = F8962Params(
    ...
    repayment_caps_single=((200, 375), (300, 950), (400, 1575)),
    applicable_figures={
