"""IRS-published 2022 Form 8962 (Premium Tax Credit) parameters.

Source: 2022 Instructions for Form 8962
(https://www.irs.gov/pub/irs-prior/i8962--2022.pdf).

Values were produced by two mutually-blind transcriber subagents, each
reading ONLY the 2022 Form 8962 instructions above (no tenforty code, no
...
tests/params_attestations/f8962_y2022.py (wired into
tests/test_params_attestation.py::F8962AttestationTests).

2022 is the second year of the ARPA-extended applicable-figure table
(0.00 floor through 150% FPL, 0.085 ceiling at 400%+, no 400% subsidy
cliff) transcribed from this year's OWN instructions, never copied from
2021. The unemployment-compensation special rule does NOT apply in 2022
(it was a 2021-only ARPA provision).
"""
