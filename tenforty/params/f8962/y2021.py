"""IRS-published 2021 Form 8962 (Premium Tax Credit) parameters.

Source: 2021 Instructions for Form 8962
(https://www.irs.gov/pub/irs-prior/i8962--2021.pdf).

Values were produced by two mutually-blind transcriber subagents, each
reading ONLY the 2021 Form 8962 instructions above (no tenforty code, no
...
tests/params_attestations/f8962_y2021.py (wired into
tests/test_params_attestation.py::F8962AttestationTests).

2021 (ARPA, American Rescue Plan Act) temporarily removed the 400% FPL
subsidy cliff and lowered required contribution percentages across the
board (0.00 floor through 150% FPL, 0.085 ceiling at 400%+); it also
carries the unemployment-compensation rule (household income treated as no
more than 133% of the FPL for the applicable figure, when unemployment
compensation was received during 2021).
"""
