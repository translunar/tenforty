"""IRS-published 2023 Form 8962 (Premium Tax Credit) parameters.

Source: 2023 Instructions for Form 8962
(https://www.irs.gov/pub/irs-prior/i8962--2023.pdf).

Values were produced by two mutually-blind transcriber subagents, each
reading ONLY the 2023 Form 8962 instructions above (no tenforty code, no
...
tests/params_attestations/f8962_y2023.py (wired into
tests/test_params_attestation.py::F8962AttestationTests).

2023 is the first year of the IRA-extended (Inflation Reduction Act)
applicable-figure table, which shares the same shape as the ARPA table
(0.00 floor through 150% FPL, 0.085 ceiling at 400%+, no 400% subsidy
cliff) but is transcribed from this year's OWN instructions, never copied
from a prior year. The unemployment-compensation special rule does NOT
apply in 2023 (it was a 2021-only ARPA provision).
"""
