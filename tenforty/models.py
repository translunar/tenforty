...
class CASchCAAdjustment:
    ...
    ``source`` for audit. Generated by the kernel from federal data when
    ``source=AUTO_DERIVED`` (UI exclusion, SS exemption, etc.); supplied
    via the .fods worksheet when ``source=WORKSHEET``."""
