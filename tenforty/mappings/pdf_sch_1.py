...
# 2024 root is form1[0] (not topmostSubform[0]).
_PAGE1_2024 = "form1[0].Page1[0]"
_PAGE2_2024 = "form1[0].Page2[0]"
...
class PdfSch1(PdfFormMapping[dict]):
    ...
    _MAPPINGS: dict[int, dict] = {
        2024: {
            "scalars": {
                # Header — 2024 uses zero-padded field names under form1[0] root.
                "taxpayer_name": f"{_PAGE1_2024}.f1_01[0]",
                "taxpayer_ssn": f"{_PAGE1_2024}.f1_02[0]",
                # Part I — Additional Income
                "sch_1_line_1_taxable_refunds": f"{_PAGE1_2024}.f1_03[0]",
                "sch_1_line_3_business_income": f"{_PAGE1_2024}.f1_07[0]",
                "sch_1_line_4_other_gains": f"{_PAGE1_2024}.f1_08[0]",
                "sch_1_line_5_rental_re_royalty": f"{_PAGE1_2024}.f1_09[0]",
                "sch_1_line_6_farm_income": f"{_PAGE1_2024}.f1_10[0]",
                # Line 7 (unemployment) is inside Line8a_ReadOrder in 2024.
                "sch_1_line_7_unemployment": f"{_PAGE1_2024}.Line8a_ReadOrder[0].f1_12[0]",
                "sch_1_line_10_total_additional_income": f"{_PAGE1_2024}.f1_33[0]",
                # Part II — Adjustments (page 2 field numbers same as 2025)
                "sch_1_line_11_educator": f"{_PAGE2_2024}.f2_01[0]",
                "sch_1_line_13_hsa": f"{_PAGE2_2024}.f2_03[0]",
                "sch_1_line_15_se_tax": f"{_PAGE2_2024}.f2_05[0]",
                "sch_1_line_17_se_health": f"{_PAGE2_2024}.f2_07[0]",
                "sch_1_line_20_ira": f"{_PAGE2_2024}.f2_12[0]",
                "sch_1_line_21_student_loan_interest": f"{_PAGE2_2024}.f2_13[0]",
                "sch_1_line_26_total_adjustments": f"{_PAGE2_2024}.f2_29[0]",
            },
            "repeaters": {},
        },
        2025: {
