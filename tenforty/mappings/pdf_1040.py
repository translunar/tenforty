...
# Mapping keyed by year. Each entry maps result keys to PDF field paths.
_MAPPINGS: dict[int, dict[str, str]] = {
    2025: {
        ...
        # Line 24: Total tax (add lines 22 and 23). This is your total tax.
        ...
        # Line 27a SSN field (f2_22 is in SSN_ReadOrder group, skip)
        ...
        # Line 30: Reserved / adoption credit
        "reserved_line30": "topmostSubform[0].Page2[0].f2_25[0]",
