...
Booklet (TY2023) at ``pdfs/california/2023/booklet.pdf`` p.25, "Nonrefundable
Renter's Credit Qualification Record" Q2 (AGI threshold) and Q11 (amount):

- ``RENTER_CREDIT_AGI_THRESHOLD``: $50,746 single/MFS, $101,492 MFJ/HoH/QSS
...
# Nonrefundable Renter's Credit — Source: pdfs/california/2023/booklet.pdf p.25
...
RENTER_CREDIT_AGI_THRESHOLD: dict[FilingStatus, int] = {
    ...
    FilingStatus.MARRIED_SEPARATELY: 50_746,
    FilingStatus.MARRIED_JOINTLY: 101_492,
    FilingStatus.HEAD_OF_HOUSEHOLD: 101_492,
    FilingStatus.QUALIFYING_WIDOW: 101_492,
}
