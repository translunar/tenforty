...
2023 IRS Form 8962 instructions (irs.gov) — no tenforty code, no other
...
SOURCES: tuple[str, ...] = (
    "2023 Instructions for Form 8962 (Premium Tax Credit) "
    "(https://www.irs.gov/pub/irs-prior/i8962--2023.pdf), Table 1-1/1-2 "
    "(federal poverty line, household size 1, 48 contiguous states + DC) "
    "and Table 2 (applicable figure).",
    "2023 Instructions for Form 8962 (Premium Tax Credit) "
    "(https://www.irs.gov/pub/irs-prior/i8962--2023.pdf), Line 28 "
    "instructions (repayment limitation, single filing status).",
    "https://www.irs.gov/pub/irs-prior/i8962--2023.pdf, Worksheet 2 "
    "(line 5 400%-FPL boundary determination).",
)

ATTESTED: dict[str, object] = {
    "year": 2023,
    # Table 1-1: 2023 Form 8962 uses the FPL guideline published in 2022
    # for a household of 1 in the 48 contiguous states + DC.
    "fpl_single_48": 13590,
    # IRA-extended (Inflation Reduction Act) table domain, first year:
    # 0.00 floor at 150% FPL through the 0.085 ceiling at 400% FPL
    # (no 400% subsidy cliff in 2023).
    ...
    # provision; it does not appear in the 2023 instructions.
    ...
    # <200% FPL -> $350; <300% -> $900; <400% -> $1,500; >=400% -> no limit.
