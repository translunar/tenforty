"""Air-gapped attestation of CA S-corp (Form 100S) params, tax year 2022.

Two independent, mutually-blind transcribers each transcribed these four
fields from the official FTB 2022 Form 100S S Corporation Tax Booklet ONLY
...
SOURCES: tuple[str, ...] = (
    "FTB 2022 Form 100S S Corporation Tax Booklet "
    "(https://www.ftb.ca.gov/forms/2022/2022-100s-booklet.pdf), "
...
ATTESTED: dict[str, object] = {
    ...
    # • S corporations . . . 1.5%" — the S-corp rate, deliberately NOT the
    # 8.84% general C-corp rate nor the 3.5% financial-S-corp rate.
