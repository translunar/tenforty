...
2021 IRS Form 8962 instructions (irs.gov) — no tenforty code, no other
...
SOURCES: tuple[str, ...] = (
    "2021 Instructions for Form 8962 (Premium Tax Credit) "
    "(https://www.irs.gov/pub/irs-prior/i8962--2021.pdf), Table 1-1/1-2 "
...
ATTESTED: dict[str, object] = {
    "year": 2021,
    # Table 1-1: 2021 Form 8962 uses the FPL guideline published in 2020
    # for a household of 1 in the 48 contiguous states + DC.
    "fpl_single_48": 12760,
    # ARPA (American Rescue Plan Act) table domain: 0.00 floor at 150% FPL
    # through the 0.085 ceiling at 400% FPL (no 400% subsidy cliff in 2021).
    "applicable_figure_floor_pct": 150,
    "applicable_figure_ceiling_pct": 400,
    # 2021 instructions carry the unemployment-compensation special rule:
    # household income is treated as no more than 133% of the FPL for the
