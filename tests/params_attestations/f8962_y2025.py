...
2025 IRS Form 8962 instructions (irs.gov) — no tenforty code, no other
...
SOURCES: tuple[str, ...] = (
    "2025 Instructions for Form 8962 (Premium Tax Credit) "
    "(https://www.irs.gov/pub/irs-prior/i8962--2025.pdf), Table 1-1/1-2 "
    "(federal poverty line, household size 1, 48 contiguous states + DC) "
    "and Table 2 (applicable figure).",
    "2025 Instructions for Form 8962 (Premium Tax Credit) "
    "(https://www.irs.gov/pub/irs-prior/i8962--2025.pdf), Line 28 "
    "instructions (repayment limitation, single filing status).",
    "https://www.irs.gov/pub/irs-prior/i8962--2025.pdf, Worksheet 2 "
    "(line 5 400%-FPL boundary determination).",
)

ATTESTED: dict[str, object] = {
    "year": 2025,
    # Table 1-1: 2025 Form 8962 uses the FPL guideline published in 2024
    # for a household of 1 in the 48 contiguous states + DC.
    "fpl_single_48": 15060,
    # IRA-extended table domain: 0.00 floor at 150% FPL through the 0.085
    # ceiling at 400% FPL (no 400% subsidy cliff in 2025).
    ...
    # provision; it does not appear in the 2025 instructions.
    ...
    # <200% FPL -> $375; <300% -> $975; <400% -> $1,625; >=400% -> no limit.
